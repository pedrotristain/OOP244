...
namespace ama{
  ...
  protected:
    ...
    bool operator>(const iProduct&) const; // Greater than operator overload. Returns true if the name of the current object is greater than the name of the received object.
    ...
    const char * name() const; // Query function that returns the address of the string storing the Product's name.
